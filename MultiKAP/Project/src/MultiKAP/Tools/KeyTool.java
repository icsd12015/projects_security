...
public class KeyTool {
    ...
    public static SecretKey constructKey (byte[] K, String algorithm) {
    ...
    public static SecretKey constructKey (byte[] K, int keySize, String algorithm) {
    ...
    public static KeyPair generateKeyPair (AlgorithmParameterSpec params, String algorithm, Provider provider) throws NoSuchAlgorithmException, NoSuchProviderException,
    ...
    public static KeyPair generateKeyPair (int keySize, String algorithm, Provider provider) throws NoSuchAlgorithmException, NoSuchProviderException {
